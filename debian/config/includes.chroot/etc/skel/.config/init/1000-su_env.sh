...
sudo ln -s /home/"$USER"/.vim /root/.vim || (>&2 echo "Failed ln 1"; exit 1)
sudo ln -s /home/"$USER"/.vimrc /root/.vimrc || (>&2 echo "Failed ln 2"; exit 1)

sudo ln -s /home/"$USER"/.zshrc /root/.zshrc || (>&2 echo "Failed ln 3"; exit 1)
